      ...
      <div className="container mx-auto px-4 py-8">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          ...
          <div>
            ...
            <ul className="space-y-2 text-sm">
              <li><Link to="/category/currency-finance" className="text-slate-300 hover:text-blue-400 transition-colors">Currency & Finance</Link></li>
              <li><Link to="/category/unit-converters" className="text-slate-300 hover:text-blue-400 transition-colors">Unit Converters</Link></li>
              <li><Link to="/category/math-tools" className="text-slate-300 hover:text-blue-400 transition-colors">Math Tools</Link></li>
              <li><Link to="/category/date-time-tools" className="text-slate-300 hover:text-blue-400 transition-colors">Date & Time Tools</Link></li>
            </ul>
          </div>
