                            ...
                            <div className="flex flex-col">
                              ...
                              <div className="relative">
                                <input
                                  ...
                                  placeholder="30"
                                  className="w-full bg-[#0f172a] text-white px-3 py-2.5 border border-[#334155] rounded-lg focus:ring-2 focus:ring-indigo-500 focus:border-indigo-500 placeholder-slate-500 text-sm transition-all"
                                />
