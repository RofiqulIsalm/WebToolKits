...
{income && Number(income) > 0 && (
  <>
    <div className="mt-4 w-full">
      <div className="bg-gray border border-blue-200 text-blue-900 px-6 py-4 rounded-md shadow-sm min-h-[90px] w-full flex items-center justify-center animate-fadeIn transition-all duration-700">
