    ...
    <>
      ...
      <div className="max-w-4xl mx-auto">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
            ...
            <div className="space-y-4">
              ...
              <div className="relative">
                ...
                <div className="relative group">
                  ...
                  <div className="absolute hidden group-hover:block bg-gray-800 text-white text-xs rounded-md px-2 py-1 top-10 right-0 w-56 shadow-lg z-10 transition-opacity duration-150">
                    {tooltips.income}
                  </div>
                </div>
              </div>
          ...
          </div> {/* ✅ properly closed Input Section */}
