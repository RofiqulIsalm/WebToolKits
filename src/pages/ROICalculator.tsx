          ...
          <section id="faq" className="space-y-6 mt-16">
            ...
            <div className="space-y-5 text-lg text-slate-100 leading-relaxed">
              <div className="bg-slate-800/60 p-4 rounded-lg border border-slate-700 shadow-sm">
                ...
                <p>
                  It depends on the risk and type of investment — for stocks, 7–10 % annualized
                  is considered healthy, while for savings accounts it may be 1–3 %.
                </p>
              </div>
              ...
              <div className="bg-slate-800/60 p-4 rounded-lg border border-slate-700 shadow-sm">
                ...
                <p>
                  No — this ROI is gross return before tax or brokerage fees. You can adjust the
                  final value to account for them manually.
                </p>
              </div>
              ...
              <div className="bg-slate-800/60 p-4 rounded-lg border border-slate-700 shadow-sm">
                ...
                <p>
                  Annualized ROI shows the average return per year — useful for comparing across
