      ...
      <div className="max-w-4xl mx-auto">
        ...
        <div className="rounded-2xl p-8 mb-8 bg-slate-900">
          ...
          <p className="text-slate-300 mb-4">
            CalculatorHub’s Tip Calculator helps you calculate tips, total bills, and per-person shares instantly.
          </p>

          <h2 className="text-yellow-500 mt-4">How to Use the Tip Calculator</h2>
          <p className="text-slate-300 mb-4">
            Enter your bill, select a tip or custom amount, and the number of people. Results are displayed automatically.
          </p>

          <h2 className="text-yellow-500 mt-4">Benefits</h2>
          <ul className="list-disc list-inside space-y-2 ml-4 text-slate-300 mb-4">
            <li>Accurate tip and total amounts</li>
            <li>Supports multiple currencies</li>
            <li>Easy to split bills among friends</li>
            <li>Visual pie chart for quick insights</li>
          </ul>
