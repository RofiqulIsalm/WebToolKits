...
export default function VolumeConverter() {
  ...
  return (
    <>
      <SEOHead
        title={seoData.volumeConverter?.title ?? 'Volume Converter'}
        description={seoData.volumeConverter?.description ?? 'Convert volumes between liters, milliliters, cubic meters, US/Imperial gallons, and more.'}
        canonical="https://calculatorhub.site/volume-converter"
        schemaData={generateCalculatorSchema(
          'Volume Converter',
          seoData.volumeConverter?.description ?? 'Convert volumes between liters, milliliters, cubic meters, US/Imperial gallons, and more.',
          '/volume-converter',
          seoData.volumeConverter?.keywords ?? ['volume converter','L to gal','mL to tsp','ft3 to m3','US to UK gallons']
        )}
        breadcrumbs={[
