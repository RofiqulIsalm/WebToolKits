              ...
              <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-3 mb-5">
                ...
                <div className="grid grid-cols-2 gap-2 w-full sm:w-auto">
                  <motion.button whileTap={reduceMotion ? {} : { scale: 0.94 }} onClick={copyLink}
                    className="relative min-h-[44px]  rounded-xl border border-white/15 bg-white/5 text-slate-100 hover:bg-white/10 hover:border-white/25 focus:outline-none focus:ring-2 focus:ring-cyan-400/50">
