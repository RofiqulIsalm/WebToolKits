        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-8">
          <div className="glow-card rounded-lg p-6 text-center">
            ...
            <p className="text-slate-300 text-sm">
              Rofiqul Islam is the Senior Partner and founder of CalculatorHub. With expertise in creating user-friendly calculators and tools, he ensures high-quality solutions and a smooth experience for all users.
            </p>
          </div>
          ...
          <div className="glow-card rounded-lg p-6 text-center">
            ...
            <p className="text-slate-300 text-sm">
              Siraj Shah is the Associate Partner at CalculatorHub. Bringing strong operational and technical skills, he supports development, user experience, and contributes to the growth and innovation of the platform.
            </p>
          </div>
        </div>
