      ...
      <div className="max-w-5xl mx-auto">
        ...
        <section className="prose prose-invert max-w-4xl mx-auto mt-16 leading-relaxed text-slate-300">
          ...
          <p>
            ...
            The EMI ≈ <strong>$405.53</strong>, total payment ≈ <strong>$24,331.80</strong>, 
            and interest ≈ <strong>$4,331.80</strong>.
          </p>

          <h2 className="text-2xl font-semibold text-cyan-300 mt-10 mb-4">
            💡 How to Reduce Car Loan Interest
          </h2>
          ...
          <section id="faq" className="space-y-6 mt-16">
            ...
            <div className="space-y-5 text-lg text-slate-100 leading-relaxed">
              <div className="bg-slate-800/60 p-4 rounded-lg border border-slate-700 shadow-sm">
                ...
                <p>
                  A good rate varies by credit score and lender — typically 6–9% for new cars and 9–13% for used ones.
                </p>
              </div>
