    ...
    <div className="max-w-4xl mx-auto">
      ...
      <div className="glow-card rounded-lg p-8 space-y-8">
        ...
        <section>
          ...
          <div className="text-slate-300 space-y-4">
            <p>
              Permission is granted to temporarily use Daily Tools Hub for personal, non-commercial transitory viewing only. This is the grant of a license, not a transfer of title, and under this license you may not:
            </p>
        ...
        <section>
          ...
          <div className="text-slate-300 space-y-4">
            <p>
              Daily Tools Hub has not reviewed all of the sites linked to our website and is not responsible for the contents of any such linked site. The inclusion of any link does not imply endorsement by Daily Tools Hub of the site. Use of any such linked website is at the user's own risk.
            </p>
          </div>
        </section>
